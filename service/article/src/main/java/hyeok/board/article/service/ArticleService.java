...
import hyeok.board.article.entity.Article;
import hyeok.board.article.entity.BoardArticleCount;
import hyeok.board.article.repository.ArticleRepository;
import hyeok.board.article.repository.BoardArticleCountRepository;
import hyeok.board.article.service.request.ArticleCreateRequest;
import hyeok.board.article.service.request.ArticleUpdateRequest;
...
import hyeok.board.common.event.payload.ArticleUpdatedEventPayload;
...
public class ArticleService {
    ...
    public ArticlePageResponse readAll(Long boardId, Long page, Long pageSize) {
        List<ArticleResponse> articles = articleRepository.findAll(boardId, (page - 1) * pageSize, pageSize).stream()
