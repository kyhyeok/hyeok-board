package hyeok.board.hotarticle.repository;
...
class HotArticleListRepositoryTest {
    ...
    void add() throws InterruptedException {
        LocalDateTime time = LocalDateTime.of(2025, 8, 6, 0, 0);
        long limit = 3;
        ...
        List<Long> articleIds = hotArticleListRepository.readAll("20250806");

        assertThat(articleIds).hasSize(Long.valueOf(limit).intValue());
        assertThat(articleIds.getFirst()).isEqualTo(4);
        assertThat(articleIds.get(1)).isEqualTo(5);
        assertThat(articleIds.get(2)).isEqualTo(2);

        TimeUnit.SECONDS.sleep(5);

        assertThat(hotArticleListRepository.readAll("20250806")).isEmpty();
    }
