...
public class LikeApiTest {
    ...
    @Test
    void likePerformance() throws InterruptedException {
        ExecutorService executorService = Executors.newFixedThreadPool(100);
        likePerformance(executorService, 1111L, "pessimistic-lock-1");
        likePerformance(executorService, 2222L, "pessimistic-lock-2");
        likePerformance(executorService, 3333L, "optimistic-lock");
    }

    void likePerformance(ExecutorService executorService, Long articleId, String lockType) throws InterruptedException {
